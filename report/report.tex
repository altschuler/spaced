...
\item Forskellige invaders, med forskellige sprites, skudtyper og antal liv (de bliver farvet røde
  alt efter hvor meget liv de har). Samtlige invaders kan kun skyde én gang pr. tidsenhed. Denne ændres ved forskellige sværhedsgrader.
\item En boss, Nicolas Cage, med minions, fuglebure, som svæver rundt om denne. Bossen kan først skades når alle dens minions er ødelagt. Modsat invaders, skyder disse minions ved tilfældige intervaller, som dog bliver mindre ved højere sværhedsgrader.
