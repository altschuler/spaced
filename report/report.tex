...
\begin{enumerate}
\item currentTime og timeDelta... (vend tilbage til dette) timeDelta bruges til at bevæge samtlige GameElementâ€™er afhængigt af den tid der er gået, sådan at de for spilleren bevæger sig med konstant hastighed uafhængigt af om tiden mellem updates varierer (probs til Simon).
...
\item Herefter bliver alle GameElementâ€™erne opdateret og eventuelt fjernet hvis de er â€œdødeâ€ (metoderne for dette er uddybet nedenfor).
